...
export const CREDIT_COSTS = {
    ...
    OPTIMIZE_BRAIN: 1,           // Mejorar con IA / Sugerir pilares o FAQs
...
export const TRIAL_INITIAL_CREDITS = 50;    // Given on trial start (lanzamiento)
export const PRO_MONTHLY_CREDITS = 250;     // Given on each monthly renewal (reset)
