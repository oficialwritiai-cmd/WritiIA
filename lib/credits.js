...
export const CREDIT_COSTS = {
    ...
    // Assistant Chat
    ASSISTANT_CHAT: 0.5,         // Per AI message in the assistant chat
 ...
 * Uses the Supabase RPC `decrement_credits_balance` for transactional safety.
 *
 * @param {object} supabase - Authenticated Supabase client (user session or service role)
 * @param {string} userId - The user's UUID
 * @param {number} amount - Number of credits to deduct (can be fractional, e.g. 0.5)
 * @param {string} actionType - Identifier for logging (e.g. 'generate_plan', 'assistant_chat')
 * @param {string|null} projectId - Optional project UUID for per-project logging
