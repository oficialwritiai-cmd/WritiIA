...
export const GenerateScriptSchema = z.object({
    ...
    // NEW: specific topics, tools or details the user wants covered
    specificDetails: safeOptional(2000),
    // NEW: user-defined CTA idea (what action to ask the audience)
    ctaIdea: safeOptional(500),
    // NEW: Improved script quality fields
    experienciaReal: safeOptional(1000),
    opinionPersonal: safeOptional(1000),
    faseCreador: safeOptional(200),
