 ...
 */
export async function saveToLibrary({ userId, type, platform, goal, content, metadata = {}, tags = [], titulo = '', projectId = null }) {
    const { data, error } = await supabase
        ...
        .insert({
            ...
            tags,
            titulo,
            script_full_text: params.script_full_text || null,
            status: 'borrador'
