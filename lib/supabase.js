...
export function createSupabaseClient() {
    ...
    // Si ya existe instancia, la devolvemos
    if (_client) return _client;

    // Usar createBrowserClient para manejar cookies automáticamente en el lado del cliente
    if (typeof window !== 'undefined') {
        _client = createBrowserClient(supabaseUrl, supabaseAnonKey);
    } else {
        // Fallback para lado servidor (aunque se prefiere usar createServerClient allá)
        _client = createBaseClient(supabaseUrl, supabaseAnonKey);
    }
