'use client';
/**
 * FORCE BUILD: 2026-03-17 14:30:00
 * Version: v4.4.30
 */
...
export default function DashboardLayout({ children }) {
    ...
    if (typeof window !== 'undefined') {
        console.log('%c🚀 WRITIAI Dashboard v4.4.30 LOADED — Absolute Sync Active', 'background: #FFD700; color: #000; padding: 4px 8px; font-weight: bold; border-radius: 4px;');
    }
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexShrink: 0 }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                >
                                    ...
                                    <span style={{ fontSize: '0.75rem', color: '#FFD700', fontWeight: 900, marginRight: '8px' }}>v4.4.30</span>
