...
export default function DashboardLayout({ children }) {
    // v5.2.3: Calendar FK Fix + Non-blocking sync
    useEffect(() => {
        console.log('%c🚀 WRITIAI Dashboard v5.2.3 LOADED', 'background: #7ECECA; color: #000; padding: 4px 8px; font-weight: bold; border-radius: 4px;');
    });
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexShrink: 0 }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                >
                                    ...
                                    <span style={{ fontSize: '0.75rem', color: '#FFB800', fontWeight: 900, marginRight: '8px' }}>v5.2.3</span>
