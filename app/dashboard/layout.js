'use client';
/**
 * FORCE BUILD: 2026-03-17 12:55:00
 * Version: v4.4.26
 */
...
export default function DashboardLayout({ children }) {
    // v4.4.26: Boot log — visible immediately on page load without requiring any action
    if (typeof window !== 'undefined') {
        console.log('%c🚀 WRITIAI Dashboard v4.4.26 LOADED — Nuclear Fix Active', 'background: #FFD700; color: #000; padding: 4px 8px; font-weight: bold; border-radius: 4px;');
    }
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexShrink: 0 }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                >
                                    ...
                                    <span style={{ fontSize: '0.75rem', color: '#FFD700', fontWeight: 900, marginRight: '8px' }}>v4.4.26</span>
